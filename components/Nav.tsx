...
const Nav = () => {
  ...
  return (
    <div className="flex flex-row justify-between w-full max-w-[1000px] mx-auto bg-green-500/10 border border-green-500/20 backdrop-blur-sm rounded-full px-4 py-2">
      ...
      <Link
        href="/login"
        className="relative rounded-full px-7 py-2 overflow-hidden group bg-green-700 relative hover:bg-gradient-to-r hover:from-green-500 hover:to-green-400 text-white hover:ring-2 hover:ring-offset-2 hover:ring-green-400 transition-all ease-out duration-300"
      >
