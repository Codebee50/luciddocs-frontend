    ...
    <div className="section-container padding-x">
      ...
      <div className="flex flex-col gap-10">
        ...
        <div className="flex flex-row items-center justify-between gap-5 mt-[100px]">
          <div className="flex flex-3 min-h-[400px] bg-[#101011] rounded-lg  flex-row items-center gap-4 pl-8">
            <div className="flex flex-col flex-1 gap-6">
              ...
              <h1 className="text-white text-4xl  font-clash gradient-text">
            ...
            <div className="flex flex-col flex-1 gap-4">
              <div className="w-full h-full bg-grey01 overflow-hidden">
                <div className="w-full bg-radial from-senary to-background  overflow-hidden h-[400px]  pl-9 pt-9">
                  <Image
